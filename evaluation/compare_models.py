...
Usage:
    python evaluation/compare_models.py --result_path results/
    python evaluation/compare_models.py --result_path results/ --output_dir results/comparison/
"""
...
from evaluation.plot.visualization import (
